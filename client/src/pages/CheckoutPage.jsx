...
const CheckoutPage = () => {
  ...
  const [selectAddress, setSelectAddress] = useState(null)  // Initialize with null to handle address selection
  ...
  const handleCashOnDelivery = async () => {
    if (selectAddress === null) {
      ...
      return;  // Prevent further execution if no address is selected
    }
      ...
      <div className='container mx-auto p-4 flex flex-col lg:flex-row w-full gap-5 justify-between'>
        ...
        <div className='w-full max-w-md bg-white py-4 px-2'>
          ...
          <div className='bg-white p-4'>
            ...
            <div className='flex gap-4 justify-between ml-1'>
              <p>Total Quantity</p>
              <p className='flex items-center gap-2'>{totalQty} Product</p>
            </div>
            <div className='flex gap-4 justify-between ml-1'>
              <p>Delivery Charge</p>
              <p className='flex items-center gap-2'>11</p>
            </div>
